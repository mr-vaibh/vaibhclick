...
<html lang="en">
<head>
  <title>Movie Download | VaiBHClick</title>
  <meta charset="utf-8">
    ...
    <ul class="nav navbar-nav">
	  ...
	  <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Download<span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li class="active"><a href="movie-download.php">Movies</a></li>
...
<div class="container">
  <!--CODE TO GIVE BOX AND BUTTON GRAPHICS-->
   ...
   <div class="main">
     <form action="#" >
	     <label style="color:white;">Search for any MOVIE -></label><input type="text" name="find" placeholder="Search..">
