    ...
    <ul class="nav navbar-nav">
	  ...
	  <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Download<span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li class="active"><a href="dll-download.php">DLL-Files</a></li>
...
<div class="container">
  <!--CODE TO GIVE BOX AND BUTTON GRAPHICS-->
   ...
   <div class="main">
     <form action="#" >
	     <label style="color:white;">Search for any DLL-File -></label><input type="text" name="find" placeholder="Search..">
